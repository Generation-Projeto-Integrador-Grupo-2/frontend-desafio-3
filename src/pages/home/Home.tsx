  ...
  const promocoes = [
    {
      ...
      precoOriginal: 49.9,
      precoPromocional: 29.0,
      imagem:
        "https://ik.imagekit.io/6tjnbersb/Espaguete-de-Abobrinha-com-Molho-de-Tomate-e-Manjericao-1-1200x675.jpg?updatedAt=1750878978575",
    },
    {
      id: 2,
      ...
      imagem:
        "https://ik.imagekit.io/6tjnbersb/lasanhacommolhobranco.jpg?updatedAt=1750878978308",
    },
    {
      id: 3,
      ...
      imagem:
        "https://ik.imagekit.io/6tjnbersb/x-tudo-de-pernil.jpg?updatedAt=1750878978740",
    },
    {
      id: 4,
      nome: "Salada Caesar",
      ...
      imagem:
        "https://ik.imagekit.io/6tjnbersb/salada-caesar-para-4-pessoas.jpg?updatedAt=1750887964352",
    },
  ];
  ...
  const categorias = [
    {
      ...
      cor: "#FDAE61",
      imagem:
        "https://ik.imagekit.io/6tjnbersb/triple-chocolate-cake-4.png?updatedAt=1750837469815",
    },
    {
      id: 2,
      nome: "Lanches",
      cor: "#FF6961",
      imagem:
        "https://ik.imagekit.io/6tjnbersb/capa-materia-gshow-2022-01-20t11(1).png?updatedAt=1750834554826",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      cor: "#A4CC68",
      imagem:
        "https://ik.imagekit.io/6tjnbersb/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0.png?updatedAt=1750838445533",
    },
    {
      id: 6,
      nome: "Fitness",
      cor: "#72DD96",
      imagem:
        "https://ik.imagekit.io/6tjnbersb/proteinbar.png?updatedAt=1750838702822",
    },
    {
      id: 4,
      nome: "Bebidas",
      cor: "#A8DADC",
      imagem:
        "https://ik.imagekit.io/6tjnbersb/glass-with-orange-juice-png-0.png?updatedAt=1750839057184",
    },
  ];
  ...
  return (
    <div className="w-full">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://ik.imagekit.io/6tjnbersb/iStock-10240457.jpg?updatedAt=1750818785429')",
        }}
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8">
          {promocoes.map((produto, index) => {
            ...
            return (
              <div
                key={produto.id}
                className="flex flex-col items-stretch transition hover:scale-105 h-full"
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="w-full md:w-1/2 text-left text-[#2F3E46]">
            ...
            <p className="text-lg leading-relaxed mb-6">
              A rebU Eats é uma rede colaborativa sem comissões, feita para
              valorizar quem produz e entrega com afeto. Conheça nossa proposta
              ética, livre e comunitária — e faça parte dessa revolução na forma
              de se alimentar.
            </p>
            <button
